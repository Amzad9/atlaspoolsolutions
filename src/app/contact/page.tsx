            ...
            <div className="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {contactOptions.map((item) => (
                ...
                >
                  ...
                  <p className="mt-5 wrap-break-word whitespace-normal text-sm font-black uppercase tracking-[0.16em] text-[#f28b93]">
                    {item.value}
                  </p>
                </a>
              ))}
            ...
            <div className="grid gap-6 lg:grid-cols-12">
              <div className="rounded-[24px] border border-[#495867] bg-linear-to-br from-[#2a3139]/95 to-[#1f252d]/95 p-6 shadow-[0_18px_44px_rgba(0,0,0,0.35)] lg:col-span-7 lg:p-8">
                ...
                <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                  <a
                    href={`mailto:${siteContact.emailShowroom}`}
                    className="inline-flex items-center justify-center rounded-full border border-[#f06a74] bg-linear-to-b from-[#ef4b57] to-[#c92d3a] px-6 py-3 text-center text-sm font-black uppercase tracking-wide text-[#fdfcfc] shadow-[0_0_14px_rgba(230,57,70,0.4)] transition hover:brightness-105 sm:w-fit sm:px-8 sm:text-base"
                  >
                    Book Via Email
                  </a>
                  <Link
